  ...
  TEMPLATE = [
    ...
    },
    {
      ...
      items: [
        ...
        {name: 'Left Front Pressure',  sequence: 6, type: 'TirePreassureItem'},
        {name: 'Right Front Pressure',  sequence: 7, type: 'TirePreassureItem'},
        {name: 'Left Rear Pressure',  sequence: 8, type: 'TirePreassureItem'},
        {name: 'Right Rear Pressure',  sequence: 9, type: 'TirePreassureItem'},
        {name: 'Spare Pressure',  sequence: 10, type: 'TirePreassureItem'},
